...
public class PaladinFormAuthenticationFilter extends FormAuthenticationFilter {
	...
	private List<ShiroLoginSuccessHandler> loginSuccessHandlers;
	...
	protected boolean onLoginSuccess(AuthenticationToken token, Subject subject, ServletRequest request, ServletResponse response) throws Exception {
		if (loginSuccessHandlers != null) {
			for (ShiroLoginSuccessHandler handler : loginSuccessHandlers) {
				handler.onLoginSuccess(token, subject, request, response);
			}
		}
	...
	public List<ShiroLoginSuccessHandler> getLoginSuccessHandlers() {
		return loginSuccessHandlers;
	}

	public void setLoginSuccessHandlers(List<ShiroLoginSuccessHandler> loginSuccessHandlers) {
		this.loginSuccessHandlers = loginSuccessHandlers;
	}
