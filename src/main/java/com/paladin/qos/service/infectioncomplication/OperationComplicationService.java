...
public class OperationComplicationService extends ServiceSupport<OperationComplication> {
	...
	/*
	 * @Transactional public OperationComplicationVO queryById(String id) { // TODO
	 * Auto-generated method stub return operationComplicationMapper.queryById(id);
	 * }
	 * 
	 * 
	 * @Transactional public int updates(OperationComplicationDTO dto) { // TODO
	 * Auto-generated method stub return operationComplicationMapper.updates(dto); }
	 * 
	 * @Transactional public int delete(String id) { // TODO Auto-generated method
	 * stub return operationComplicationMapper.deletes(id); }
	 * 
	 * @Transactional public Object insertInto(OperationComplicationVO vo) { // TODO
	 * Auto-generated method stub UserSession userSession =
	 * UserSession.getCurrentUserSession(); String uid = userSession == null ? "" :
	 * userSession.getUserId(); vo.setCreateTime(new Date()); return
	 * operationComplicationMapper.insertInto(vo); }
	 */
