...
public class EpidemicSituationService extends ServiceSupport<EpidemicSituation> {
	...
	public ExcelImportResult importEpidemic(InputStream excelInputStream) {
		...
		ExcelReader<ExcelEpidemicSituation> reader = new ExcelReader<>(ExcelEpidemicSituation.class, epidemicImportColumns,
	 ...
	 * @return
	 */
	public List<OrgSchoolCountsGroupByNatureVO> epidemicCountsGroupByUnit(OrgSchoolCountsQuery query) {
	 ...
	 * @return
	 */
	public List<OrgSchoolCountsGroupByNatureVO> epidemicPeopleCountsGroupByUnit(OrgSchoolCountsQuery query) {
		return epidemicSituationMapper.epidemicPeopleCountsGroupByUnit(query);
	}

	public List<OrgSchoolEpidemicRateVO> queryEpidemicRatesByAffiliation(OrgSchoolCountsQuery query) {

		return epidemicSituationMapper.queryEpidemicRatesByAffiliation(query);
	}

	public List<OrgSchoolEpidemicRateVO> queryEpidemicRatesByNature(OrgSchoolCountsQuery query) {
