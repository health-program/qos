...
import com.paladin.framework.core.configuration.shiro.PaladinShiroFilterFactoryBean;
...
public class QosShiroConfiguration {
    ...
    private static Logger logger = LoggerFactory.getLogger(QosShiroConfiguration.class);
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(DefaultWebSecurityManager securityManager, ShiroCasProperties shiroCasProperties) {
        ...
        QosAnonymousFilter qosAnonymousFilter = new QosAnonymousFilter();
        filters.put("qos-anon", qosAnonymousFilter);
        ...
        filterChainDefinitionMap.put("/**", "qos-anon");
