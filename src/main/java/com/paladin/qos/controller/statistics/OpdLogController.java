 ...
 */
@Controller
@RequestMapping("/qos/opd/log")
public class OpdLogController {
	...
	return "/qos/statistics/opd_log_index";
    }

    @RequestMapping(value = "/find/page", method = { RequestMethod.GET,RequestMethod.POST })
    @ResponseBody
    public Object findPage(OpdQuery query) {
	return CommonResponse.getSuccessResponse(opdLogService.searchFindPage(query));
    }
}
