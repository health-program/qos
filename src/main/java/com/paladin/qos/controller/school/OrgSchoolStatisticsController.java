...
@Controller
@RequestMapping("/" + GlobalProperties.project + "/org/school/statistic")
public class OrgSchoolStatisticsController extends ControllerSupport {
    ...
    public String index() {
	return "/" + GlobalProperties.project + "/school/org_school_personnel_statistics";
    }
    
    @RequestMapping(value = "/doctor/index")
    @QueryInputMethod(queryClass = OrgSchoolQuery.class)
    public String doctorIndex() {
	return "/" + GlobalProperties.project + "/school/org_school_doctor_statistics";
    }
    ...
    /**
     * 学校校医配备核查情况
     * 统计每个学校专职校医,兼职校医,专职保健老师,兼职保健老师人数
     * @param query
     * @return
     * @see [类、类#方法、类#成员]
     */
