			...
			if (query != null) {
				if (condition.isExportAll()) {
					return CommonResponse.getSuccessResponse("success",
							ExportUtil.export(condition, epidemicSituationService.searchAll(query), EpidemicSituation.class));
				} else if (condition.isExportPage()) {
					return CommonResponse.getSuccessResponse("success",
							ExportUtil.export(condition, epidemicSituationService.searchPage(query).getData(), EpidemicSituation.class));
				}
			}
