...
public class DeathRateController {
	...
	public Object getDeathRate(AnalysisRequest request) {
        ...
        eventIds.add("10100");eventIds.add("10110");eventIds.add("10111");eventIds.add("10112");
        eventIds.add("10113");eventIds.add("10114");eventIds.add("10115");eventIds.add("10116");
