...
public class RehospitalzationAnalysisPancreatitis extends YiyuanDataProcessor {
	...
	private RehospitalzationAnalysisPancreatitisMapper mapper;
	@Autowired
	private SqlSessionContainer sqlSessionContainer;

	public RehospitalzationAnalysisPancreatitisMapper getMapper() {
		if (mapper == null) {
			mapper = sqlSessionContainer.getMapper(RehospitalzationAnalysisPancreatitisMapper.class);
		}
		return mapper;
	}
