$(function(){
    ...
    $.ajax({
        ...
        success: function (res){
            ...
            //初始化echarts实例
            var rateElderlyID = echarts.init(document.getElementById('rateElderly'));
            rateElderlyID.setOption(rateElderlyOption);
            var index = 0; //播放所在下标
            var mTime = setInterval(function() {
                rateElderlyID.dispatchAction({
                    type: 'showTip',
                    seriesIndex: 0,
                    dataIndex: index
                });
