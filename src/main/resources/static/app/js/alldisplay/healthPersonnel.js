        ...
        url : URLPATH+"/home/page/qos/org/person/select/data",//请求的 URL地址
         success: function (rawData) {
           var sumData=rawData.result;
            ...
            var arr = 0.6;
            var data = max * arr;
            var health=sumData.healthPeopleNumber;
            var nonHealth=sumData.nonHealthPeopleNumber;
            var healthRate=(health *100/ (health+nonHealth)).toFixed(1) + '%';
            var nonHealthRate=(nonHealth *100/ (health+nonHealth)).toFixed(1) + '%';
            document.getElementById('health').innerText="卫计人数："+health+"人 占比："+healthRate;
            document.getElementById('nonHealth').innerText="非卫计人数："+nonHealth+"人 占比："+nonHealthRate;
            var healthPersonnelOption = {
                title: {
                    top: '47%',
                    left: 'center',
                    text: '卫计人数：'+(health *100/ (health+nonHealth)).toFixed(1) + '%',
                    textStyle: {
                        color: '#fff',
                        fontSize: 15
                    },
            ...
            var healthPersonnelID = echarts.init(document.getElementById('healthPersonnel'));
            healthPersonnelID.setOption(healthPersonnelOption);
            window.addEventListener("resize", function () {
                healthPersonnelID.resize();
            });
        }
    });
