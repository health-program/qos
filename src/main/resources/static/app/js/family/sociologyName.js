$(function(){
     $.ajax({
         type : "post",    //请求类型
        url : "http://10.9.1.41:18081/home/page/qos/team/find/all",//请求的 URL地址
         ...
         */
          ...
          $.each(data, function(i, item) { //这里的函数参数是键值对的形式，k代表键名，v代表值
              ...
              html += '<li class="doctor_unitName">'+item.unitName+'</li>';
              html += '<li  class="doctor_teamName">'+item.teamName+'</li>';
              html += '<li  class="doctor_names">'+item.name+'</li>';
              html += '<li  class="doctor_ages">'+item.age+'</li>';
              html += '<li  class="doctor_jobRank">'+item.jobRank+'</li>';
              html += '<li  class="doctor_personnelCategory">'+item.personnelCategory+'</li>';
